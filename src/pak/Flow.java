...
public class Flow {
    ...
    private static boolean settings_game_mode(String arg) {
        try{
    ...
    private static boolean settings_change_difficulty(String arg) {
    ...
    private static boolean settings_remove(String arg) {
    ...
    private static boolean settings_set(String[] args) {
